# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-09-03 22:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'A user with that username already exists.'}, help_text='Required. 7 characters.', max_length=8, unique=True, validators=[django.core.validators.RegexValidator('^[\\w]+$', 'Enter a valid username. This value may contain only letters, numbers characters.')], verbose_name='Prontuário')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datanascimento', models.DateField(default=django.utils.timezone.now, help_text='dd/mm/yyyy', verbose_name='Data de nascimento')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('remetente_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='notificacao.Remetente')),
                ('datafundacao', models.DateField(blank=True, help_text='dd/mm/yyyy', null=True, verbose_name='Data de fundação')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('remetente_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='notificacao.Remetente')),
                ('ano', models.IntegerField(choices=[(2016, 2016), (2017, 2017), (2018, 2018), (2019, 2019), (2020, 2020)], default=2016, verbose_name='year')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_tipo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='notificacao.TipoFormacao', verbose_name='Tipo formação')),
            ],
            options={
